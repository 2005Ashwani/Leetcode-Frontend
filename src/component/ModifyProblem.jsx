...
export default function ModifyProblem() {
  ...
  const dummmyData = {
    ...
    problemCreator: "66ca2b74f3a12b2a9f3d9e88",
    referenceSolution: [
      {
        language: "C++",
        completeCode:
  ...
  const onSubmit = async (data) => {
    data.problemCreator = "68aa1574e8c8c6708c8afc63";

    console.log(data)
    try {
      await axiosClient.post("/problem/create", dummmyData);
            ...
            <div className="form-control">
              ...
              <input
                ...
                className={`input input-bordered ${
                  errors.tittle && "input-error"
                }`}
              />
              {errors.title && (
                <span className="text-error">{errors.tittle.message}</span>
              )}
            </div>
