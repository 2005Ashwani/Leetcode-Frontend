...
export default function Tree_Graph() {
  ...
  const isMainPage = location.pathname === "/searching-sorting" || location.pathname === "/";
...
// hading animation
 ...
 <div
  ...
  className="two-box flex justify-center items-center flex-col bg-base-200 min-h-screen overflow-hidden mt-0">
  {isMainPage && (
    ...
    >
      ...
      <span className="text-primary animate-pulse drop-shadow-lg hover:scale-105 transition-transform duration-500">
        SEARCHING
      </span>
      <span className="text-base-content"> & </span>
      <span className="text-secondary animate-pulse drop-shadow-lg hover:scale-105 transition-transform duration-500">
        SORTING
      </span>
    </h1>
      ...
      <nav className="flex flex-col sm:flex-row justify-center items-center gap-6 sm:gap-8 md:gap-12 w-full">
        ...
        <Link
          to="searching"
          className={`w-full sm:w-[45%] max-w-md h-48 sm:h-64 md:h-80 rounded-3xl hover:shadow-2xl transition-all duration-500 flex items-center justify-center relative overflow-hidden group bg-primary
        ...
        <Link
          to="sorting"
          className={`w-full sm:w-[45%] max-w-md h-48 sm:h-64 md:h-80 rounded-3xl hover:shadow-2xl transition-all duration-500 flex items-center justify-center relative overflow-hidden group bg-secondary
            ${animate ? "translate-x-0 opacity-100" : "-translate-x-full opacity-0"}
      ...
      <div className="mt-12 sm:mt-16 text-center">
        <p className="text-base-content/70 text-sm sm:text-base max-w-2xl mx-auto">
          Interactive visualization of searching and sorting data structures with animations and step-by-step explanations.
        </p>
      </div>
    </div>
  )}
